      ...
      <div className="bg-darkBg/80 backdrop-blur-sm relative z-10 min-h-screen pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-8 md:px-12">
          <div className="w-full text-center mb-16 md:mb-20 pointer-events-auto z-10 relative">
            <h1 className="text-lg md:text-2xl font-extrabold uppercase tracking-[0.2em] text-glow-purple inline-block relative text-white">
              {title}
          ...
          <div className="prose prose-invert max-w-none text-gray-300">
            ...
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">2. Usage</h2>
            <p className="mb-4">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
            </p>
            <h2 className="text-2xl font-semibold text-white mt-8 mb-4">3. Data and Privacy</h2>
            <p className="mb-4">
